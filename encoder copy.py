...
for i in range(numberOfOffsets):
    ...
    if(currentScore < smallestTapeScore):
        if(len(tape) <= len(file)):
            print("WHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAT")
            print("perfect or smaller!!!!!!")
            print(smallestTapeScore)
            print()
            print()
            print(tape)
        ...
        print(tape)
        smallestTape = tape
        smallestTapeScore = currentScore
    # print(f"looped {i}")
